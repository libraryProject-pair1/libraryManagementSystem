...
public interface IAuthorBooksService
{
    ...
    Task<AuthorBook> AddAsync(AuthorBook authorBooks);
    Task<AuthorBook> UpdateAsync(AuthorBook authorBooks);
    Task<AuthorBook> DeleteAsync(AuthorBook authorBooks, bool permanent = false);
}
